...
## Goal
Port I2S microphone dBA pipeline.

## Scope
- **In scope:** Compute noiseAvg/noiseMax and publish values.
- **Out of scope:** No display rendering.
...
- `app/src/sensors/noise_i2s/*`
- `tests/sensors/noise_i2s/*`

## Source pointers (read before coding)
- `airalab/altruist-firmware: sensors/i2s_noise_sensor.cpp`
