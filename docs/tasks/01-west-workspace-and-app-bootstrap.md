# WP-01: West workspace and app bootstrap
...
## Goal
Create a minimal buildable Zephyr app/workspace baseline.

## Scope
- **In scope:** Set up west manifest and app skeleton only.
- **Out of scope:** Do not implement product features.
