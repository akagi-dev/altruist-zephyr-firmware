# WP-20: Web configuration API and pages
...
## Goal
Port config/status/values/ota web endpoints and static pages.

## Scope
- **In scope:** Implement HTTP handlers and persistence integration.
- **Out of scope:** No deep Insight display stack.
...
- `app/src/web/server.c`
- `app/src/web/routes/*`
- `app/web_assets/*`
- `tests/web/*`

## Source pointers (read before coding)
- `airalab/altruist-firmware: webserver/webserver.cpp`
- `airalab/altruist-firmware: webserver/pages/pages.h`
- `airalab/altruist-firmware: webserver/html-content.h`
