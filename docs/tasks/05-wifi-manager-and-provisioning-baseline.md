# WP-05: WiFi manager and provisioning baseline
...
## Goal
Implement WiFi STA lifecycle and provisioning entrypoints.

## Scope
- **In scope:** Add net_mgmt state handling, reconnects, and provisioning hooks.
- **Out of scope:** No full HTML UI.
...
- `app/src/net/wifi_manager.c`
- `app/src/provisioning/provisioning.c`
- `app/include/altruist/wifi_manager.h`
- `tests/net/*`

## Source pointers (read before coding)
- `airalab/altruist-firmware: wifi_manager.cpp`
- `airalab/altruist-firmware: improv/improv_serial.cpp`
