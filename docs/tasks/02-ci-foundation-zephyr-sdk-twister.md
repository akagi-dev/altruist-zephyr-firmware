...
## Goal
Add CI for build and Twister smoke tests.

## Scope
- **In scope:** Add workflow + test harness for native_sim and compile checks.
- **Out of scope:** Do not add HIL or complex infra.
...
- `airalab/altruist-firmware: README.md`
