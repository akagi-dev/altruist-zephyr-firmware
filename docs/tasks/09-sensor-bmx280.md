...
## Goal
Port BMx280 I2C sensor driver.

## Scope
- **In scope:** Map temperature/humidity/pressure values.
- **Out of scope:** No BME680/SCD4x here.
...
- `app/src/sensors/bmx280/*`
- `tests/sensors/bmx280/*`

## Source pointers (read before coding)
- `airalab/altruist-firmware: sensors/bmx280i2c_sensor.cpp`
