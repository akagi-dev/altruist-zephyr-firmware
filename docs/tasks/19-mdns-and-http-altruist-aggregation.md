# WP-19: mDNS and HTTP Altruist aggregation
...
## Goal
Port Insight↔Urban discovery and HTTP aggregation sensor.

## Scope
- **In scope:** mDNS query/announce plus fallback to configured IP.
- **Out of scope:** No display pages.
...
- `app/src/net/mdns_service.c`
- `app/src/sensors/http_altruist/*`
- `tests/sensors/http_altruist/*`
