...
## Goal
Port BME680 sensor driver.

## Scope
- **In scope:** Expose temp/humidity/pressure/gas fields.
- **Out of scope:** No analytics coupling.
...
- `app/src/sensors/bme680/*`
- `tests/sensors/bme680/*`

## Source pointers (read before coding)
- `airalab/altruist-firmware: sensors/bmx680i2c_sensor.cpp`
