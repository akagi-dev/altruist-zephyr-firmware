# WP-03: Board and variant profiles
...
## Goal
Create board/profile configs for Urban C3, Urban C6, Insight C6.

## Scope
- **In scope:** Define Kconfig and devicetree overlays per variant.
- **Out of scope:** No driver/business logic.
...
- `app/boards/*`
- `app/Kconfig.variants`
- `app/prj_urban_c3.conf`
- `app/prj_urban_c6.conf`
- `app/prj_insight_c6.conf`

## Source pointers (read before coding)
- `airalab/altruist-firmware: platformio.ini`
- `airalab/altruist-firmware: esp32c3_partitions.csv`
- `airalab/altruist-firmware: esp32c6_partitions.csv`
