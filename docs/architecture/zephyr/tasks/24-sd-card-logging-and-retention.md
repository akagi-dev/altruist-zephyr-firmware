...
## Goal
Port CSV logging and retention/rollup jobs.

## Scope
- **In scope:** Support write/read windows used by analytics/graphs.
- **Out of scope:** No graph UI implementation.
...
- `app/src/storage/sd_logger/*`
- `tests/storage/sd_logger/*`

## Source pointers (read before coding)
- `airalab/altruist-firmware: sd_card/sd_card.cpp`
