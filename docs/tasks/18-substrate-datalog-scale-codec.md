# WP-18: Substrate datalog + SCALE codec
...
## Goal
Implement datalog extrinsic encoding/signing/submission path.

## Scope
- **In scope:** Create portable SCALE codec and extrinsic builder module.
- **Out of scope:** No web UI management.
