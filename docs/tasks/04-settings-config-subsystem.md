...
## Goal
Port configuration persistence and defaults to Zephyr Settings.

## Scope
- **In scope:** Create config schema, defaults, and read/write/reset support.
- **Out of scope:** No web pages yet.
...
- `app/include/altruist/config.h`
- `app/src/config/config_store.c`
- `app/src/config/config_defaults.c`
- `tests/config/*`

## Source pointers (read before coding)
- `airalab/altruist-firmware: config_manager/config_helpers.cpp`
- `airalab/altruist-firmware: config_manager/config_defaults.h`
- `airalab/altruist-firmware: config_manager/airrohr-cfg.h`
