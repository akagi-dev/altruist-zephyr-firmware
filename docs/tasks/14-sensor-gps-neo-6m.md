...
## Goal
Port TinyGPS/UART ingestion pipeline.

## Scope
- **In scope:** Publish latitude/longitude fields.
...
- `airalab/altruist-firmware: sensors/tiny_gps_sensor.cpp`
