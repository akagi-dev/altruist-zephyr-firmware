# WP-22: OTA with MCUboot channels
...
## Goal
Implement MCUboot dual-slot OTA and stable/testing channel policy.

## Scope
- **In scope:** Add updater workflow and channel-aware artifact selection.
- **Out of scope:** No unrelated UI redesign.
