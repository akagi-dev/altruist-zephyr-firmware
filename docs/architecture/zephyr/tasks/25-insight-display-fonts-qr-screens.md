# WP-25: Insight display, fonts, QR, screens
...
- Phase: **Phase 6**
- Dependencies: **03,21,23**

This task must be completed **without** relying on other package files except listed dependencies.

## Goal
Port Insight display manager and core screen UX.

## Scope
- **In scope:** Implement screen FSM, fonts, QR rendering, button navigation.
- **Out of scope:** No complete analytics fusion logic.
...
- `app/src/insight/display/*`
- `app/assets/fonts/*`
- `app/assets/qr/*`
- `tests/insight/display/*`

## Source pointers (read before coding)
- `airalab/altruist-firmware: display/display_manager.cpp`
- `airalab/altruist-firmware: display/*`
- `airalab/altruist-firmware: icons/*`
