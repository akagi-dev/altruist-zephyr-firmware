...
## Goal
Port AGS3871 sensor support.

## Scope
- **In scope:** Implement driver wrapper and value mapping.
...
- `app/src/sensors/ags3871/*`
- `tests/sensors/ags3871/*`

## Source pointers (read before coding)
- `airalab/altruist-firmware: sensors/ags3871_sensor.cpp`
