...
## Goal
Implement EN/RU localization for web and runtime labels.

## Scope
- **In scope:** Port translation keys and locale selection.
- **Out of scope:** No additional languages.
...
- `app/src/i18n/*`
- `app/include/altruist/i18n.h`
- `tests/i18n/*`

## Source pointers (read before coding)
- `airalab/altruist-firmware: intl.h`
- `airalab/altruist-firmware: translations/intl_en.h`
- `airalab/altruist-firmware: translations/intl_ru.h`
